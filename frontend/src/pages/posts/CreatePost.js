...
function CreatePost({ onUpdate }) {
  ...
  useEffect(() => {
    const getPieces = async () => {
      ...
      setPieces(json);
      setPieces([
        { piece_id: 1, title: "Test 1", artist: "Turing 1" },
        { piece_id: 2, title: "Test 2", artist: "Turing 2" },
        { piece_id: 3, title: "Test 3", artist: "Turing 3" },
        { piece_id: 4, title: "Test 4", artist: "Turing 2" },
      ]);
    };
