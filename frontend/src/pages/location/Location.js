...
const Location = () => {
  ...
  const fetchLocation = async () => {
    ...
    console.log("Location Page PJSON", pjson);
        ...
        <div className="p-16">
          <div className="p-8 bg-white border shadow-sm rounded-xl mt-24">
            ...
            <div className="mt-20 text-center pb-12">
              <h1 className="text-4xl font-medium text-gray-700">{locationData.name}</h1>
              <p className="text-2xl font-light text-gray-500 mt-3">{locationData.st_address}<br/>{locationData.city}, {locationData.region} {locationData.postcode}<br/> {locationData.country}</p>
            </div>
